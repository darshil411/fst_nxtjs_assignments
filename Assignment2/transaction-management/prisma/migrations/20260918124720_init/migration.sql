...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('USER_CREATED', 'USER_UPDATED', 'USER_DELETED', 'TRANSACTION_CREATED', 'TRANSACTION_UPDATED', 'TRANSACTION_DELETED', 'LOGIN', 'LOGOUT', 'EMAIL_SENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "EmailEvent_eventId_key" ON "EmailEvent"("eventId");
